...
print "%s ____ ___ %s                                  /               B" % (W, Y)

print "%s / __// o.) %s.__ %s . . . %s                    /                A" % (W, B, R, G)

print "%s / _/ / o \ %s[ __._._ . .[_) %s|_| _. _.;_/ %s / |_  _ _|_ _  |  B" % (W, B, R, B)

print "%s /_/ /___,' %s[_./[ (_)(_|[ _%s | |(_](_.| \ %s/  |_)(_) | (_) |  A" % (W, B, R, W)

print " %s_____________________________%s|%s______________________________%s " % (W, G, B, N)
print " %s@%s Author %s: %sMonir Hossain%s" % (G, M, W, B, N)
print " %s@ github :%s https://github.com/botolmonir%s" % (Y, G, N)
print " %s@ tool :%s facebook group hacking tool%s" % (R, M, N)
print " %s@ facebook : %s https://www.facebook.com/monir.hossain.8%s" % (B, R, N)
print " %s@ use this tool in your own risk . . . .%s" % (Y, N)
print "%s_______________________________________________%s" % (M, N)
CorrectUsername = "botolbaba"
CorrectPassword = "bababotol"
